...
<div id="layout-body" class="container">
  <div class="row">
    ...
    <?php if ($title): ?>
      <h1
        class="col-lg-<?php print $cols['title']['lg']; ?> col-md-<?php print $cols['title']['md']; ?> col-sm-<?php print $cols['title']['sm']; ?> col-xs-<?php print $cols['title']['xs']; ?>"
        id="page-title">
        <?php print $title; ?>
      </h1>
    <?php endif; ?>
  ...
  <div class="row">
    ...
    <div id="content-wrapper"
      ...
      <div class="row">
        <div
          class="col-lg-<?php print $cols['content']['lg']; ?> col-md-<?php print $cols['content']['md']; ?> col-sm-<?php print $cols['content']['sm']; ?> col-xs-<?php print $cols['content']['xs']; ?>">
  ...
  <div id="featured-bottom" class="column"><div class="section">
    <?php print $regions['featured_bottom']; ?>
    </div>
  </div> 
